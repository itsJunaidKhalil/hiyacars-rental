...
from app.api.v1 import auth_supabase, vehicles, bookings, payments, kyc, contracts, loyalty, reviews
...
app.include_router(auth_supabase.router, prefix="/api/v1/auth", tags=["Authentication"])
